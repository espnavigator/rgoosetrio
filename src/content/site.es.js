...
export const music = {
  ...
  featured: {
    ...
    personnel: [
      { name: 'Ramon Goose', role: 'Guitarra eléctrica, voz' },
      { name: 'Joe “Ricardo” Goose', role: 'Bajo' },
      { name: 'Kieffer Santander', role: 'Percusión, voz' },
  ...
  groups: [
    ...
    },
    {
      ...
      members: [
        ...
        { name: 'Calderín', role: 'Contrabajo', photo: '', bio: '' },
        { name: 'Ernesto', role: 'Bongó', photo: '', bio: '' },
      ],
    },
  ],
...
export const cuba = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        'Alejandro Almenares es un guitarrista santiaguero de la tradición trovadoresca, con un linaje que entra directamente en la música que hizo famosa el Buena Vista Social Club. Estamos grabando juntos.',
        '',
      ],
    },
  ],
