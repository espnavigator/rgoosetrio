...
export const home = {
  ...
  bandBlurb: [
    ...
    'In England it is a trio, led by Ramon Goose and Kieffer Santander. Kieffer plays percussion — Peruvian, based here, one of the leading players of Afro-Peruvian and Criollo rhythm in Europe, and the reason the band moves the way it does: cajón, congas, bongó and the quijada, a donkey’s jawbone played by rattling the teeth. Joe Goose plays bass, and is my identical twin brother, which is a shortcut through about thirty years of rehearsal.',
      ...
      items: [
        {
          ...
          body:
            'In Cuba I play through a 10-inch Eminence Blue in a Hughes & Kettner cab and a 12-inch Jensen ceramic in a Filmosound cab. The Filmosound amplifier runs at 110 volts, which is what Cuba runs on, so it works as long as the electricity is on. One Filmosound lives in Cuba, and the second comes back to the UK with me every time. The red Strat is one of the two electric guitars I keep there. It has Alan Dingwall pickups, a Brazilian rosewood fingerboard, Jim Dunlop 6100 frets and a reverse tremolo, like Jimi Hendrix’s and Stevie Ray Vaughan’s. Alejandro Almenares often plays it, and he really likes it.',
        },
        {
          name: 'The rig',
